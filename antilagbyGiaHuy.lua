-- ⚡ Roblox Ultimate FPS Boost + Music + FPS Counter
-- Xóa hiệu ứng, giảm đồ họa, phát nhạc ID 115925172742147 (loop), hiển thị FPS nhỏ gọn
...
fpsLabel.Position = UDim2.new(1, -105, 0, 5) -- góc phải trên
